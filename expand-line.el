...
(defvar expand-line-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "<up>") 'expand-line-expand-previous-line)
    (define-key map (kbd "<down>") 'expand-line-expand-next-line)
    (define-key map (kbd "S-<up>") 'expand-line-contract-previous-line)
    (define-key map (kbd "S-<down>") 'expand-line-contract-next-line)
